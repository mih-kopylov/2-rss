...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/angular-animate.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/resources/js/angular-aria.js" type="text/javascript"></script>
